...
import {
    ...
    faPen, faPlus, faHouseChimney, faCakeCandles, faEnvelope, faCamera, faThumbsUp, faBook, faLessThan, faGreaterThan, faFileArrowUp, faFileArrowDown, faFileExport, faFile, faFileCircleCheck,
...
library.add(
    ...
    faCircleCheck, faListUl, faFileLines, faHandPointDown, faRightToBracket, faEllipsis, faRobot, faCircleXmark, faPen, faPlus, faHouseChimney, faCakeCandles, faEnvelope, faCamera, faThumbsUp, faBook, faLessThan, faGreaterThan, faFileArrowUp, faFileExport, faFileArrowDown,
    faFileExport, faFile, faFileCircleCheck,
